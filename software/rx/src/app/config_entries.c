...
static const config_entry_mapping_t _config_entries_mapping[] = {
    ...
    { .name = "kr-rx-ch-map",   .parse = kr_rx_parse_array,           .print = kr_rx_print_array, .payload = &_config_entries_config.kr_rx.channel_mapping, .help ="kr-rx value"},
    { .name = "kr-rx-failsafe", .parse = kr_rx_parse_array,           .print = kr_rx_print_array, .payload = &_config_entries_config.kr_rx.channel_failsafe, .help ="kr-rx value"},
    { .name = "kr-rx-loop-ms",  .parse = CONFIG_PARSE_FUNC(uint32_t), .print = CONFIG_PRINT_FUNC(dec,uint32_t), .payload = &_config_entries_config.kr_rx.loop_cmd_period_ms, .help ="kr-rx value"},
