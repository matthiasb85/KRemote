...
#define NRF_EVENT_RX_EVENT     1

#define NRF_DEFAULT_PA  NRF_PA_HIGH
#define NRF_DEFAULT_DA  NRF_1MBPS
#define NRF_DEFAULT_CH  79
#define NRF_DEFAULT_AW  NRF_AW_5BYTE
#define NRF_DEFAULT_AD  {0x13, 0x37, 0xab, 0xcd, 0xef}
#define NRF_DEFAULT_RXT 10

#define NRF_MAX_ADDR_LENGTH    5
...
#define NRF_STATE_LED           PAL_LINE(GPIOB, 1U)
