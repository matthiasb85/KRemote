...
static config_entries_t _config_entries_config = {
    ...
    .kr_tx = {
        ...
        .loop_cmd_period_ms = KR_TX_LOOP_CMD_P_MS
    },
    .rc_input = {
        .digital_switch_mode = {
...
static const config_entry_mapping_t _config_entries_mapping[] = {
    ...
    { .name = "kr-tx-loop-ms",   .parse = CONFIG_PARSE_FUNC(uint32_t), .print = CONFIG_PRINT_FUNC(dec,uint32_t), .payload = &_config_entries_config.kr_tx.loop_cmd_period_ms,    .help = "Period in ms for loop cmd"},
